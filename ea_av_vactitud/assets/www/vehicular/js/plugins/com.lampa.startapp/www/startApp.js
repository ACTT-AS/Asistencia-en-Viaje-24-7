cordova.define("plugin.startapp", function(require, exports, module) { /**
	com.lampa.startapp
...
module.exports = {
	...
	openMain: function(message, completeCallback, errorCallback) {
    		exec(completeCallback, errorCallback, "startApp", "openMain", [message]);
    	}
}
