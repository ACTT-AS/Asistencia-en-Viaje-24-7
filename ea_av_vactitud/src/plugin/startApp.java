...
import com.appcode.ea.CareMenuSplashActivity;
...
public class startApp extends CordovaPlugin {
    ...
    public void openMain(String component, CallbackContext callback) {
        Intent i = new Intent(this.cordova.getActivity().getApplicationContext(), CareMenuSplashActivity.class);
